...
/** v2表的实现，可以暴露出v1类型表的元数据
  * 构造器参数: v1Table: CatalogTable v1类型表
  * 属性列表:
  *   @options: Map[String, String] 配置表
  *   @properties: util.Map[String, String] 属性表
  *   @schema: StructType schema信息
  *   @partitioning: Array[Transform] 转换器表
 */
